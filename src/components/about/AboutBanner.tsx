...
const AboutBanner = ()=>{
    return(
        <section className="flex flex-col md:flex-row flex-wrap items-center justify-between bg-black mt-5 p-20 md:pr-72 md:pl-96 bg-[url('/images/bannerBg.psd')] bg-cover bg-no-repeat bg-center border-t-4 border-t-[#3ae51d]">
